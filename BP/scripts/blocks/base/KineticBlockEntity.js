...
export default class KineticBlockEntity {
  ...
  initialize() {
    ...
    //super.initialize();
    //^^^ This might not be needed cus we dont have the smartblockentity class
    // but if u want to make the smartblockentity class so the entity can rotate etc go ahead :) - goofy
  }
