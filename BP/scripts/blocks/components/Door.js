...
world.beforeEvents.worldInitialize.subscribe(initEvent => {
    initEvent.blockTypeRegistry.registerCustomComponent('create:door', {
        beforeOnPlayerPlace: e => {
            ...
            upper_block.setPermutation(e.permutationToPlace.withState("create:half", 'upper').withState("create:hinge", hinge));
            ...
            if (neighbour.hasTag("door")) {
                ...
                if ((nHinge != hinge) && (direction == nDirection)) {
                    ...
                    if (nOpen == open) {
                        ...
                        if (!open) {
                            const entity2 = e.dimension.spawnEntity(bottom.typeId, bottom.bottomCenter());
